...
To run the default campaign, run `uv run launch_chainlit.py` from the project's root directory. This will use the adventure guide and knowledge graph for LMoP included in this repo. A new browser window for your default browser will open automatically. Enter your questions or actions directly into the text window and hit enter to submit, as if you were speaking to a human DM.
